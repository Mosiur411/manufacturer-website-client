...
const Service = () => {
    ...
    const { data: services, isLoading, } = useQuery('service', () => fetch('https://manufacturer-website-server-production-2545.up.railway.app/service', {
        method: 'GET',
        headers: {
    ...
    //https://manufacturer-website-server-production-2545.up.railway.app
    // https://manufacturer-website-server-production-2545.up.railway.app/service
